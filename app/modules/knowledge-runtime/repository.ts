...
// Generic function words that would otherwise "match" almost any record and
// pollute matchedKeywords/rationale with meaningless overlap (e.g. "and").
const STOPWORDS = new Set([
  "and", "the", "for", "with", "from", "this", "that", "into", "over",
  "are", "was", "were", "been", "have", "has", "had", "not", "but", "per",
]);
